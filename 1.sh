...
OPENAI_API_KEY=$OPENAI_API_KEY CODE=$CODE PORT=$PORT PROXY_URL="https://oa.api2d.net" yidadaa/chatgpt-next-web yarn build
OPENAI_API_KEY=$OPENAI_API_KEY CODE=$CODE PORT=$PORT PROXY_URL="https://oa.api2d.net" yidadaa/chatgpt-next-web yarn start
